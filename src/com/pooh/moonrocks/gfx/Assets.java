...
public class Assets {
    ...
    public static BufferedImage cactusTree, signPost;
    public static BufferedImage waterItem, woodItem;
    ...
    public static void init() {
        ...
        waterItem = ImageLoader.loadImage("/textures/waterItem.png");
        woodItem = ImageLoader.loadImage("/textures/woodItem.png");
